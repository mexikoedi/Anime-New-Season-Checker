 ...
 * container. That is the x/y coordinate must be within the Insets of the
...
public class DragLayout implements LayoutManager, java.io.Serializable {
	 ...
	 *
	 * @param usePreferredSize when true, use the preferred size of the component in
	 *                         layout calculations. When false, use the size of the
	 *                         component, unless the size is 0, in which case use
	 *                         the preferred size as a default.
	 */
