...
/**
 * The DragLayout is used as a layout manager for a Container that supports random dragging of
 * components with the Container.
 *
 * <p>The location of the component will not be managed by the layout manager.
 *
 * <p>The size of the component can be either the preferred size of the component, or the actual
 * size of the component.
 *
 * <p>The preferred size of the container will calculated normally based on the actual location and
 * size of each component.
 *
 * <p>A Component cannot have a location outside the bounds of the parent container. That is the x/y
 * coordinate must be within the Insets of the Container. If any component is outside the bounds,
 * then the location of all components will be adjusted by the same amount.
 */
public class DragLayout implements LayoutManager, java.io.Serializable {
   ...
   *
   * @param usePreferredSize when true, use the preferred size of the component in layout
   *     calculations. When false, use the size of the component, unless the size is 0, in which
