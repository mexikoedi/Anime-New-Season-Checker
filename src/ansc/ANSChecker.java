...
public class ANSChecker {
	...
	private void initStandardGuiElements() {
		 ...
		 */
		this.tfAnimeHeadline = initTextField(dragPanel,
				COLOR_GREEN,
		...
		this.tfAnimeSeasonHeadline = initTextField(dragPanel,
				COLOR_GREEN,
				SwingConstants.CENTER,
				522, 10, 160, 44,
				FONT_TEXTFIELD,
		...
		this.tfAnimeRunHeadline = initTextField(dragPanel,
				COLOR_GREEN,
				SwingConstants.CENTER,
				692, 10, 400, 44,
				FONT_TEXTFIELD,
		...
		this.tfControls = initTextField(dragPanel,
				COLOR_GREEN,
				SwingConstants.CENTER,
				1102, 10, 274, 44,
				FONT_TEXTFIELD,
		...
		this.tfSeason = initTextField(dragPanel,
		...
		this.btnSeason = new JButton("Confirm season");
		this.btnSeason.setFont(new Font("Tahoma", Font.PLAIN, 15));
		this.btnSeason.setBounds(1102, 114, 274, 44);
		this.btnSeason.addActionListener(e -> tfSeason.setText(tfSeason.getText()));
		this.dragPanel.add(btnSeason);
		...
		this.tfAnimeCount = initTextField(dragPanel,
				COLOR_CYAN,
				SwingConstants.CENTER,
				1102,214, 274, 44,
				FONT_BUTTON,
		...
		this.tfDuration = initTextField(dragPanel,
				COLOR_CYAN,
				SwingConstants.CENTER,
				1102, 264, 274, 44,
				FONT_BUTTON,
	...
	private void initAnimeListGuiElements() {
		...
		for (Anime anime : this.animeList) {
			...
			this.tfAnimeRunMap.put(anime.getName(),
					initTextField(this.dragPanel,
							COLOR_LIGHTGREY,
							null,
							692, 64 + i, 400, 44,
	...
	private JTextField initTextField(JPanel dragPanel,
	...
	private void checkButtonPressed() {
		...
		/*
		 * picLoading removed from the DragLayout (not visible now) and picLoaded added instead
		 * (visible now).
		 */
